...
public class VentanaProductos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query="";
            query="insert into productos (producto, precio) values (";
            
           query = query+"'"+ jTextField1.getText()+"',";
           query = query+""+ jTextField2.getText();
...
//         System.out.println(jTable1.getValueAt(jTable1.getSelectedRow(),2).toString());
 ...
 Conexion con = new Conexion();
        ...
        try {
            ...
            String query="";
            query= query+ "delete from productos where id=";
